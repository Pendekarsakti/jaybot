...
const { color, bgcolor } = require('./jayganz/color')
const { animesaran } = require('./jayganz/animesaran')
const { animesaran2 } = require('./jayganz/animesaran2')
const { help } = require('./jayganz/help')
const { rules } = require('./jayganz/rules')
const { sewabot } = require('./jayganz/sewabot')
const { donasi } = require('./jayganz/donasi')
const { fetchJson } = require('./jayganz/fetcher')
const { recognize } = require('./jayganz/ocr')
...
const lolhuman = 'RPL~1YT' //Besok Beli Sendiri
const onlydev = 'OnlyOneDevelover' //Free Apikey
const xteam = 'RPL~1BotWa' //Hari Jumat Habis

//Ubah
const namaowner = 'JAY ARNOLD LINGGA'
const namabot = 'RPL~1 BOT'

//kontak
const vcard = 'BEGIN:VCARD\n'  //Jangan diganti,Ntar error
            + 'VERSION:3.0\n'  //Jangan diganti,Ntar error
            + 'FN:Jay\n'  // Ganti jadi namamu
            + 'ORG:Pengembang $RPL~1 BOT;\n'  // Ganti jadi namamu/Botmu
            + 'TEL;type=CELL;type=VOICE;waid=6283193695837:+6283103229573\n'  // Ganti jadi nomormu, tapi jangan ubah polanya
            + 'END:VCARD' // Jangan diganti,Ntar Error
            
//settings            
prefix = '#'
blocked = []   
limitawal = '999999999999' //Terserah Mo Ganti apa kgk
memberlimit = 999999999999999 //Terserah Mo Ganti apa kgk
cr = '*RPL~1 Bot By JAY ARNOLD LINGGA*'
vr = '*RPL~1 Bot Wa*\n*RPL~1 Bebas*'

//owner number
const ownerNumber = ["6283193695837@s.whatsapp.net"]  //Ganti Jadi Nomormu
